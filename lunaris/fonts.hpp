...
namespace lunaris {
    ...
    char* get_system_font(){
            ...
            return font_path;
        #elif defined(linux)
            if(__internal::is_file_exist((char*)"/usr/share/fonts/noto/NotoSans-Regular.ttf")) return (char*)"/usr/share/fonts/noto/NotoSans-Regular.ttf";
            ...
            if(__internal::is_file_exist((char*)"/usr/share/fonts/truetype/ubuntu/Ubuntu-M.ttf")) return (char*)"/usr/share/fonts/truetype/ubuntu/Ubuntu-M.ttf";
            return (char*)"/usr/share/fonts/truetype/noto/NotoMono-Regular.ttf";
